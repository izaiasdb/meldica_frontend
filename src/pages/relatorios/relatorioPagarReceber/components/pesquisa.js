                ...
                <Row gutter={12}>
                    ...
                    {/* <Col span={ 8 }>
                        <Form.Item label={"Unidade Prisional"}>
                            {
                                getFieldDecorator('obj.idUnidadeList', {
                                    rules: [{required: true, message: 'Por favor, informe uma unidade.'}],
                                    initialValue: unidadeAtual.id ? [unidadeAtual.id] : []
                                })(
                    ...
                    <Col span={6}>
                        <Form.Item label={"Tipo log"}>
                            {
                                getFieldDecorator('obj.idTipoTerminalLog', {
                                    initialValue: null
                                })(
                                <Select showSearch
                                        optionFilterProp="children"
                                        ...
                                        {generateOptions(tipoTerminalList)}
                                </Select>                                        
                                )
                            }
                        </Form.Item>
...
const mapDispatchToProps = (dispatch) => ({
    ...
    pesquisar: (obj) => dispatch(Action.relatorioPagarReceberPesquisar(obj)),
})
