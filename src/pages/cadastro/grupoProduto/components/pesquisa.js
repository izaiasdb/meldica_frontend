...
class Pesquisa extends Component {
    ...
    getExtra = () => {
        return (
            <div>
                <Button type={ "primary"}
                        htmlType="submit"
                        disabled = {!hasAnyAuthority("GRUPO_PRODUTO_CONSULTAR")}
                ...
                <Divider type="vertical" />
                <Button type={ "primary"} 
                            disabled = {!hasAnyAuthority("GRUPO_PRODUTO_INSERIR")}
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, { grupoProduto }) => {
            if (!err) {
                this.props.pesquisar(grupoProduto)
            } else {
...
const mapDispatchToProps = (dispatch) => ({
    init: ()  => dispatch(Actions.grupoProdutoInit()),
    cleanTable: () => dispatch(Actions.grupoProdutoCleanTable()),
    setGrupoProduto: () => dispatch(Actions.grupoProdutoSetGrupoProduto()),
    pesquisar: (grupoProduto) => dispatch(Actions.grupoProdutoPesquisar(grupoProduto)),
